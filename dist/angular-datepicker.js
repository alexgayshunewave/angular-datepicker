...
Module.directive('dateTime', ['$compile', '$document', '$filter', 'dateTimeConfig', '$parse', 'datePickerUtils', function ($compile, $document, $filter, dateTimeConfig, $parse, datePickerUtils) {
  ...
  return {
    ...
    link: function (scope, element, attrs, ngModel) {
      ...
      attrs.$observe('positionCustomOffset', function (val) {
        positionCustomOffset = ~~val;
      });
      ...
      function showPicker() {
        ...
        if (position === 'absolute') {
          ...
          if ((posInput.bottom + posPicker.height + positionCustomOffset) > window.innerHeight) {
...
$templateCache.put('templates/datepicker.html',
    "<div ng-switch=\"view\">\n" +
    "  <div ng-switch-when=\"date\" type=\"date\">\n" +
    "    <table>\n" +
    "      <thead>\n" +
    "      <tr>\n" +
    ...
    "    </table>\n" +
    "  </div>\n" +
    "  <div ng-switch-when=\"year\" type=\"year\">\n" +
    "    <table>\n" +
    "      <thead>\n" +
    "      <tr>\n" +
    ...
    "    </table>\n" +
    "  </div>\n" +
    "  <div ng-switch-when=\"month\" type=\"month\">\n" +
    "    <table>\n" +
    "      <thead>\n" +
    "      <tr>\n" +
    "        <th ng-click=\"prev()\">&lsaquo;</th>\n" +
    ...
    "    </table>\n" +
    "  </div>\n" +
    "  <div ng-switch-when=\"hours\" type=\"hours\">\n" +
    "    <table>\n" +
    "      <thead>\n" +
    "      <tr>\n" +
    ...
    "    </table>\n" +
    "  </div>\n" +
    "  <div ng-switch-when=\"minutes\" type=\"minutes\">\n" +
    "    <table>\n" +
    "      <thead>\n" +
    "      <tr>\n" +
    "        <th ng-click=\"prev()\">&lsaquo;</th>\n" +
